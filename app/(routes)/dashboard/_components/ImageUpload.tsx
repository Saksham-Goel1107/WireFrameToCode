...
function ImageUpload() {
    ...
    const OnConverToCodeButtonClick = async () => {
        if (!file || !model || !description) {
            ...
            toast.error("Please select image, model and add description");
            return;
        }
        setLoading(true);
        ...
        try {
            ...
            // Wait for the file to be read as data URL
            const base64String = await fileReadPromise;
            
            // Upload via Cloudinary API endpoint
            const formData = new FormData();
            formData.append('image', base64String as string);
            
            // Use the Cloudinary upload API route
            ...
            if (!uploadResponse.ok) {
                ...
                throw new Error(uploadResult.details || 'Failed to upload image through API');
            }
